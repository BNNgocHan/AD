...
namespace TrainingFPT.Models.Queries
{
    public class CourseQuery
    {
        ...
        //public bool UpdateCourseById(string nameCourse, int categoryId, string description, DateTime startDate, DateTime? endDate, string viewImageCourse, string status, int Id)
        //{
        //    using (SqlConnection connection = Database.GetSqlConnection())
        //    {
        //        string sqlQuery = @"
        //            UPDATE [Courses]
        //            SET [NameCourse] = @NameCourse,
        ...
        //        cmd.Parameters.AddWithValue("@Image", viewImageCourse);
        //        cmd.Parameters.AddWithValue("@Status", status);
        //        cmd.Parameters.AddWithValue("@Id", Id);
        ...
        //// Hàm lấy thông tin chi tiết của khóa học bằng ID
        //public CourseDetail GetDataCourseById(int id)
        //{
        //    CourseDetail courseDetail = new CourseDetail();
        //    using (SqlConnection connection = Database.GetSqlConnection())
        //    {
